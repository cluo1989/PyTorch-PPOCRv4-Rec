...
Date: 2024-05-22 18:00:13
LastEditors: Cristiano-3 chunanluo@126.com
LastEditTime: 2024-06-03 16:49:48
FilePath: /PyTorch-PPOCRv4-Rec/ppocr/modeling/backbones/rec_lcnetv3.py
Description: LCNetV3
'''
import torch
...
class Act(nn.Module):
    def __init__(self, act='hardswish', lr_mult=1.0, lab_lr=0.1):
        super().__init__()
...
class SELayer(nn.Module):
    def __init__(self, channel, reduction=4, lr_mult=1.0):
        ...
        self.conv2 = nn.Conv2d(
            ...
            stride=1,
            padding=0)
        self.hardsigmoid = Activation('hardsigmoid')
